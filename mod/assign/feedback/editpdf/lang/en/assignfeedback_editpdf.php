...
$string['configpdfsettings'] = 'Select parameter that should be used by ghostscript';
...
$string['pdfsettings'] = 'PDF-Settings for dpi';
...
$string['maxpagetoflatten'] = 'Flatten pages';
$string['maxpagetoflatten_help'] = 'Configure up to what pagecount documents are flattened to retain students annotations.';
...
$string['flattenpdfenableddefault'] = 'Flatten pdf by default';
$string['configflattenpdfenableddefault'] = 'If enabled, then new assignments with feedback editpdf have activated to flatten ' .
    ' pdf when starting annotating assignmentsubmissions that contains pdf files.';
$string['flattenpdfenabled'] = 'Annotate PDF: Flatten pdf';
$string['flattenpdfenablednotset'] = '<br><font color="red">This setting is not stored. Please save the assignment.</font>';
$string['flattenpdfenabled_help'] = 'If enabled, the submitted files will be flatten to make annotations on layers visible. (Will lose quality and resolution.)';
$string['flattenpdfenableddefault_iseditable'] = 'Annotate PDF: Flatten pdf feature can be edited';
$string['configflattenpdfenableddefault_iseditable'] = 'Flattening pdf by default can be edited when the instance is added or updated.';
$string['forceflattenoldassigments'] = 'Force flattening in old or imported assigments';
$string['configforceflattenoldassigments'] = 'Should old assigments that that were created bevor the setting flattenpdfenabled was supported should force flattening or not.';
