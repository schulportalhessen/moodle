...
class feedback_test extends \advanced_testcase {
    ...
    public function test_get_gs_command_for_pdf() {
        ...
        $expectedvalue = "$gsexec -q -sDEVICE=pdfwrite -dSAFER -dBATCH -dNOPAUSE -dPDFSETTINGS=/$PDFSETTINGS " .
        ...
        $expectedvalue = "$gsexec -q -sDEVICE=pdfwrite -dSAFER -dBATCH -dNOPAUSE -dPDFSETTINGS=/$PDFSETTINGS -dPreserveAnnots=false " .
            "-sOutputFile=$tempdstarg $tempsrcarg";
        $this->assertEquals($expectedvalue,
            \assignfeedback_editpdf\pdf::get_gs_command_for_pdf($tempsrcarg, $tempdstarg, $pdfshouldbeflattend));
    }
