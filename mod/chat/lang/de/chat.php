...
/**
 * Strings for component 'chat', language 'de', version '3.9'.
 *
 * @package     chat
 * @category    string
...
$string['allowinnewchatneverdeletemessages'] = 'Chatprotokolle niemals löschen';
...
$string['configstudentlogsdefault'] = 'Wenn aktiviert, sind beim Anlegen eines Chats standardmäßig die Chat-Protokolle für alle Kursteilnehmenden sichtbar.';
...
$string['defaultkeeptime'] = 'Speicherdauer-Voreinstellung';
...
$string['studentlogsdefault'] = 'Voreinstellung: "Chat-Protokolle sichtbar für alle"';
